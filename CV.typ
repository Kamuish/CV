...
#two-col-entry(
  left-content: [
    ...
    #v(design-highlights-top-margin);#highlights([Invited assistant Professor to teach a PhD-level unit on high-resolution spectroscopy],)
  ],
  right-content: [
    Physics department
...
#two-col-entry(
  left-content: [
    #link("https://indico.global/event/13951/overview")[#strong[ENAA XXXV]], A Quest to Detect a Star Velocity: Radial Velocity Extraction and Associated Challenges
  ],
  right-content: [
    Sept 2025
  ],
...
#two-col-entry(
  left-content: [
    #link("https://www.iastro.pt/research/conferences/eprv6/")[#strong[EPRV6]], A systematic bias in template-based RV extraction algorithms
  ],
  right-content: [
    July 2025
  ],
...
#two-col-entry(
  left-content: [
    #strong[Astronomical Institute of the Czech Academy of Sciences], Avenues and challenges for radial velocity extraction -- s-BART & PoET
  ],
  right-content: [
    Aug 2025
  ],
...
#two-col-entry(
  left-content: [
    #strong[ASTRA: A Python Package for Cross-Instrument Stellar and Telluric Template Construction]
...
#one-col-entry(content:[
  #v(design-highlights-top-margin);André M. Silva et al; \(JOSS, #link("http://dx.doi.org/10.21105/joss.09413")[10.21105\/joss.09413]\)])

#v(design-entries-vertical-space-between-entries)
#two-col-entry(
  left-content: [
    #strong[A systematic bias in template-based radial velocity extraction algorithms]
...
#one-col-entry(content:[
  #v(design-highlights-top-margin);André M. Silva et al; \(A&A, #link("http://dx.doi.org/10.1051/0004-6361/202554955")[10.1051\/0004-6361\/202554955]\)])
...
#one-col-entry(content:[
  #v(design-highlights-top-margin);André M. Silva et al; \(A&A, #link("http://dx.doi.org/10.1051/0004-6361/202142262")[10.1051\/0004-6361\/202142262]\)])
...
#one-col-entry(content:[
  #v(design-highlights-top-margin);André M. Silva et al; \(Monthly Notices of the Royal Astronomical Society, #link("http://dx.doi.org/10.1093/mnras/staa1443")[10.1093\/mnras\/staa1443]\)])
...
#two-col-entry(
  left-content: [
    #strong[Gas-depleted planet formation occurred in the four-planet system around the red dwarf LHS 1903]
...
#one-col-entry(content:[
  #v(design-highlights-top-margin);Wilson et al; \(Science, #link("http://dx.doi.org/10.1126/science.adl2348")[10.1126\/science.adl2348]\)])

#v(design-entries-vertical-space-between-entries)
#two-col-entry(
  left-content: [
    #strong[A comprehensive study on radial velocity signals using ESPRESSO: Pushing precision to the 10 cm\/s level]
...
#one-col-entry(content:[
  #v(design-highlights-top-margin);Figueira et al; \(A&A, #link("http://dx.doi.org/10.1051/0004-6361/202553869")[10.1051\/0004-6361\/202553869]\)])
...
#two-col-entry(
  left-content: [
    #strong[Coordinator of internal working group focused on modelling time-series for exoplanet detection and characterisation]
  ],
  right-content: [
    2025 - now
  ],
...
#two-col-entry(
  left-content: [
    #strong[Organizer of the scientific seminars of CAUP]
  ],
  right-content: [
    September 2025 - now
  ],
...
#two-col-entry(
  left-content: [
    #strong[Coordinator and lecturer of advanced course \"Python for astronomers\"]
  ],
  right-content: [
    2021 - now
  ],
...
#one-col-entry(
  content: [
    #two-col(left-column-width: design-highlights-summary-left-margin, right-column-width: 1fr, left-content: [], right-content: [#v(design-highlights-top-margin);#align(left, [2022 \(3 talks\); 2023 \(5 online; 5 in-person\); 2024 \(6 online; 4 in-person\); 2025 \(6 in-person; 17 online\)])], column-gutter: 0cm)
  ],
)
