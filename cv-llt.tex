...
\address{Instituto de Astrofísica e Ciências do Espaço}{Universidade de Lisboa}{Portugal}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty

\homepage{https://kamuish.github.io/content/}

% Instituto de Astrofísica e Ciências do Espaço

\extrainfo{Ciencia ID: 2416-D5A6-DFA5%\\Date of birth: 1st of May 1996}                 % optional, remove / comment the line if not wanted
